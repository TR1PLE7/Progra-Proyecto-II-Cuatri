...
public class MapaPotrero extends JFrame {
    ...
    public MapaPotrero(int cantidadPotreros) {
        ...
        DefaultTableModel modelDisponibles = new DefaultTableModel(matrizPotrerosDisponibles, null);
        tableDisponibles.setModel(modelDisponibles);
        tableDisponibles.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        DefaultTableModel modelOcupados = new DefaultTableModel(matrizPotrerosOcupados, null);
        ...
        botonMostrarOcupados.addActionListener(e -> {
            ventanaOcupados.setVisible(true); 
        });
    ...
    if (!encontradoOcupado ==encontradoOcupado) {
       JOptionPane.showInternalConfirmDialog(null, "NO ENCONTRADO", "ROTACION FALLIDA",JOptionPane.DEFAULT_OPTION,JOptionPane.WARNING_MESSAGE,null );
    }else if(!encontradoLibre == encontradoLibre){
        JOptionPane.showInternalConfirmDialog(null, "NO ENCONTRADO", "ROTACION FALLIDA",JOptionPane.DEFAULT_OPTION,JOptionPane.WARNING_MESSAGE,null );
        }
    }
}
